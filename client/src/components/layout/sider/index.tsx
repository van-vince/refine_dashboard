...
export const Sider: typeof DefaultSider = ({ render }) => {
          ...
          >
            <ListItemButton
              ...
              sx={{
                ...
                "&.Mui-selected": {
                  "&:hover": {
                    backgroundColor: isSelected? "#fc7e00" : "transparent",
                  },
                  backgroundColor: isSelected? "#fc7e00" : "transparent",
                },
                justifyContent: "center",
            ...
            >
              <ListItemIcon
                sx={{
                  justifyContent: "center",
                  minWidth: 36,
                  color: isSelected ? '#FCFCFC' : '#FCFCFC' 
                }}
              >
                {icon ?? <ListOutlined />}
              </ListItemIcon>
              <ListItemText
                ...
                primaryTypographyProps={{
                  noWrap: true,
                  fontSize: "16px",
                  fontWeight: isSelected ? '#FCFCFC' : '#FCFCFC',
                  marginLeft:'10px'
                }}
              />
            </ListItemButton>
  ...
  return (
    <>
      <Box sx={{width: { xs: drawerWidth() }, display: {xs: "none", md: "block",},transition: "width 0.3s ease", }}/>
      <Box component="nav" sx={{ position: "fixed", zIndex: 1101, width: { sm: drawerWidth() }, display: "flex", }}>
        <Drawer
          variant="temporary"
          open={opened}
