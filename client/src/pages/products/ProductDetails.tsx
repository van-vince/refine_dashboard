...
const PoductDetails = () => {
    ...
    return (
        <Show resource="products" isLoading={true}
        breadcrumb={
        ...
        <Box borderRadius="15px" padding="20px" bgcolor="#FCFCFC" width="fit-content">
            ...
            <Box mt="20px" display="flex" flexDirection={{ xs: "column", lg: "row" }} gap={4}>
                <Box flex={1} maxWidth={764}>
                    <img
                        src={poductDetails.photo}
                        alt="poduct_details-img"
                        height={546}
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                src={
                                    checkImage(poductDetails.creator.avatar)
                                        ? poductDetails.creator.avatar
                            ...
                            <Typography
                                ...
                                color="#11142D"
                            >
                                {poductDetails.creator.allProducts.length}{" "}
                                Products
                            </Typography>
                        </Stack>
                        ...
                        >
                            ...
                            <CustomButton
                                ...
                                handleClick={() => {
                                    if (isCurrentUser) handleDeletePoduct();
                                }}
                            />
                        </Stack>
                    </Stack>
